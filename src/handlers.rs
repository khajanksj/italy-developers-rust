...
async fn ensure_seed(db: &Database) -> Result<(), AppError> {
    ...
    if migrations.find_one(doc! {"key":"translations-tech-v1"}).await?.is_none() {
        apply_translations_tech_v1(db).await?;
        migrations.insert_one(doc! {"key":"translations-tech-v1","applied_at":DateTime::now()}).await?;
    }
    if migrations.find_one(doc! {"key":"translations-insight-v1"}).await?.is_none() {
        apply_translations_insight_v1(db).await?;
        migrations.insert_one(doc! {"key":"translations-insight-v1","applied_at":DateTime::now()}).await?;
    }
    if migrations.find_one(doc! {"key":"translations-about-v1"}).await?.is_none() {
        apply_translations_about_v1(db).await?;
        migrations.insert_one(doc! {"key":"translations-about-v1","applied_at":DateTime::now()}).await?;
    }
    if migrations.find_one(doc! {"key":"translations-testimonial-v1"}).await?.is_none() {
        apply_translations_testimonial_v1(db).await?;
        migrations.insert_one(doc! {"key":"translations-testimonial-v1","applied_at":DateTime::now()}).await?;
    }
...
async fn apply_translations_tech_v1(db: &Database) -> Result<(), AppError> {
    let rows: Vec<Translated> = vec![
        Translated{slug:"rust-actix",lang:"it",title:"Rust full-stack: Actix Web + Askama",eyebrow:"Ingegneria backend",summary:"Prodotti e API resi lato server, veloci e affidabili, costruiti con Rust, Actix Web e template Askama type-safe.",glance:"",body:"<p class=\"lead\">Usiamo Rust in tutto lo stack web quando affidabilità, sicurezza ed efficienza operativa contano.</p><h2>Cosa costruiamo</h2><ul><li>API Actix Web, middleware, sessioni e integrazioni</li><li>Interfacce rese lato server con Askama, forte SEO e basso overhead JavaScript</li><li>Persistenza MongoDB o PostgreSQL</li><li>Pannelli admin sicuri, upload e delivery Docker in produzione</li></ul><p>Questo sito web è un riferimento funzionante dello stesso stack.</p>",seo_title:"Rust e Actix Web | Italy Developers",seo_description:"Sviluppo di sistemi memory-safe e applicazioni web rese lato server efficienti, con validazione esplicita e prestazioni prevedibili.",cta:"Parliamo di un progetto concreto"},
        Translated{slug:"rust-actix",lang:"de",title:"Rust Full-Stack: Actix Web + Askama",eyebrow:"Backend-Engineering",summary:"Schnelle, verlässliche serverseitig gerenderte Produkte und APIs, gebaut mit Rust, Actix Web und typsicheren Askama-Templates.",glance:"",body:"<p class=\"lead\">Wir setzen Rust im gesamten Web-Stack ein, wenn Zuverlässigkeit, Sicherheit und effizienter Betrieb wichtig sind.</p><h2>Was wir bauen</h2><ul><li>Actix-Web-APIs, Middleware, Sitzungen und Integrationen</li><li>Serverseitig gerenderte Askama-Oberflächen mit starkem SEO und geringem JavaScript-Overhead</li><li>MongoDB- oder PostgreSQL-Persistenz</li><li>Sichere Admin-Panels, Uploads und Produktions-Docker-Delivery</li></ul><p>Diese Website ist eine funktionierende Referenz für denselben Stack.</p>",seo_title:"Rust und Actix Web | Italy Developers",seo_description:"Speichersichere Systementwicklung und effiziente serverseitig gerenderte Webanwendungen mit expliziter Validierung und vorhersehbarer Leistung.",cta:"Besprechen Sie ein konkretes Projekt"},
        Translated{slug:"rust-actix",lang:"fr",title:"Rust full-stack : Actix Web + Askama",eyebrow:"Ingénierie backend",summary:"Produits et API rendus côté serveur, rapides et fiables, construits avec Rust, Actix Web et des templates Askama à typage sûr.",glance:"",body:"<p class=\"lead\">Nous utilisons Rust sur toute la pile web lorsque la fiabilité, la sécurité et l'efficacité opérationnelle comptent.</p><h2>Ce que nous construisons</h2><ul><li>API Actix Web, middleware, sessions et intégrations</li><li>Interfaces rendues côté serveur avec Askama, fort SEO et faible surcharge JavaScript</li><li>Persistance MongoDB ou PostgreSQL</li><li>Panneaux admin sécurisés, téléversements et livraison Docker en production</li></ul><p>Ce site web est une référence fonctionnelle de la même pile.</p>",seo_title:"Rust et Actix Web | Italy Developers",seo_description:"Développement de systèmes memory-safe et applications web rendues côté serveur efficaces, avec validation explicite et performance prévisible.",cta:"Discutons d'un projet concret"},
        Translated{slug:"rust-actix",lang:"pt",title:"Rust full-stack: Actix Web + Askama",eyebrow:"Engenharia de backend",summary:"Produtos e APIs renderizados no servidor, rápidos e confiáveis, construídos com Rust, Actix Web e templates Askama com tipagem segura.",glance:"",body:"<p class=\"lead\">Usamos Rust em toda a stack web quando confiabilidade, segurança e operação eficiente importam.</p><h2>O que construímos</h2><ul><li>APIs Actix Web, middleware, sessões e integrações</li><li>Interfaces renderizadas no servidor com Askama, forte SEO e baixo overhead de JavaScript</li><li>Persistência MongoDB ou PostgreSQL</li><li>Painéis admin seguros, uploads e entrega Docker em produção</li></ul><p>Este site é uma referência funcional da mesma stack.</p>",seo_title:"Rust e Actix Web | Italy Developers",seo_description:"Desenvolvimento de sistemas memory-safe e aplicações web renderizadas no servidor eficientes, com validação explícita e desempenho previsível.",cta:"Vamos falar sobre um projeto concreto"},

        Translated{slug:"python-django-drf",lang:"it",title:"Python full-stack: Django, FastAPI + GraphQL",eyebrow:"Ecosistema Python",summary:"Applicazioni aziendali, sistemi admin e integrazioni usando Django, DRF, FastAPI, GraphQL e automazione Python.",glance:"",body:"<p class=\"lead\">Python ci offre un percorso produttivo dal workflow operativo a un prodotto web mantenibile.</p><h2>Capacità</h2><ul><li>Applicazioni full-stack Django e flussi admin sicuri</li><li>Servizi Django REST Framework e FastAPI</li><li>API REST e GraphQL con validazione e permessi</li><li>Automazione, reportistica e integrazione AI</li><li>Livelli dati PostgreSQL o MongoDB</li></ul><p>Il nostro pacchetto pubblico DRF Shapeless Serializers fornisce una prova ispezionabile di lavoro avanzato su serializer e API.</p>",seo_title:"Python, Django e Django REST Framework | Italy Developers",seo_description:"Sviluppo backend produttivo per applicazioni data-driven, flussi admin, API e pacchetti riutilizzabili.",cta:"Parliamo di un progetto concreto"},
        Translated{slug:"python-django-drf",lang:"de",title:"Python Full-Stack: Django, FastAPI + GraphQL",eyebrow:"Python-Ökosystem",summary:"Geschäftsanwendungen, Admin-Systeme und Integrationen mit Django, DRF, FastAPI, GraphQL und Python-Automatisierung.",glance:"",body:"<p class=\"lead\">Python bietet uns einen produktiven Weg vom operativen Workflow zum wartbaren Webprodukt.</p><h2>Fähigkeiten</h2><ul><li>Django-Full-Stack-Anwendungen und sichere Admin-Workflows</li><li>Django-REST-Framework- und FastAPI-Dienste</li><li>REST- und GraphQL-APIs mit Validierung und Berechtigungen</li><li>Automatisierung, Berichte und KI-Integration</li><li>PostgreSQL- oder MongoDB-Datenschichten</li></ul><p>Unser öffentliches DRF-Shapeless-Serializers-Paket liefert überprüfbaren Beleg für fortgeschrittene Serializer- und API-Arbeit.</p>",seo_title:"Python, Django und Django REST Framework | Italy Developers",seo_description:"Produktive Backend-Entwicklung für datengetriebene Anwendungen, Admin-Workflows, APIs und wiederverwendbare Pakete.",cta:"Besprechen Sie ein konkretes Projekt"},
        Translated{slug:"python-django-drf",lang:"fr",title:"Python full-stack : Django, FastAPI + GraphQL",eyebrow:"Écosystème Python",summary:"Applications métier, systèmes admin et intégrations utilisant Django, DRF, FastAPI, GraphQL et l'automatisation Python.",glance:"",body:"<p class=\"lead\">Python nous offre un chemin productif du flux opérationnel vers un produit web maintenable.</p><h2>Capacités</h2><ul><li>Applications full-stack Django et flux admin sécurisés</li><li>Services Django REST Framework et FastAPI</li><li>API REST et GraphQL avec validation et permissions</li><li>Automatisation, reporting et intégration IA</li><li>Couches de données PostgreSQL ou MongoDB</li></ul><p>Notre paquet public DRF Shapeless Serializers fournit une preuve vérifiable de travail avancé sur les sérialiseurs et les API.</p>",seo_title:"Python, Django et Django REST Framework | Italy Developers",seo_description:"Développement backend productif pour applications data-driven, flux admin, API et paquets réutilisables.",cta:"Discutons d'un projet concret"},
        Translated{slug:"python-django-drf",lang:"pt",title:"Python full-stack: Django, FastAPI + GraphQL",eyebrow:"Ecossistema Python",summary:"Aplicações empresariais, sistemas admin e integrações usando Django, DRF, FastAPI, GraphQL e automação Python.",glance:"",body:"<p class=\"lead\">Python nos dá um caminho produtivo do fluxo operacional a um produto web sustentável.</p><h2>Capacidades</h2><ul><li>Aplicações full-stack Django e fluxos admin seguros</li><li>Serviços Django REST Framework e FastAPI</li><li>APIs REST e GraphQL com validação e permissões</li><li>Automação, relatórios e integração de IA</li><li>Camadas de dados PostgreSQL ou MongoDB</li></ul><p>Nosso pacote público DRF Shapeless Serializers fornece prova inspecionável de trabalho avançado em serializers e APIs.</p>",seo_title:"Python, Django e Django REST Framework | Italy Developers",seo_description:"Desenvolvimento de backend produtivo para aplicações orientadas a dados, fluxos admin, APIs e pacotes reutilizáveis.",cta:"Vamos falar sobre um projeto concreto"},

        Translated{slug:"mongodb",lang:"it",title:"Sistemi dati MongoDB + PostgreSQL",eyebrow:"Livello dati",summary:"Design pratico di database a documenti e relazionali, indicizzazione, migrazioni, backup e integrazione applicativa.",glance:"",body:"<p class=\"lead\">Scegliamo il database intorno al prodotto invece di forzare ogni workflow in un unico modello.</p><h2>MongoDB</h2><p>Un ottimo adattamento per contenuti in evoluzione e dati operativi a forma di documento, quando si mantiene disciplina su schema e indici.</p><h2>PostgreSQL</h2><p>Un ottimo adattamento per workflow relazionali, reportistica, vincoli e sistemi ad alto carico transazionale.</p><h2>Basi di produzione</h2><p>Accesso a privilegio minimo, migrazioni, indici, backup cifrati, test di ripristino e monitoraggio delle query fanno parte della consegna.</p>",seo_title:"MongoDB | Italy Developers",seo_description:"Archiviazione orientata ai documenti per contenuti in evoluzione, record operativi, richieste, commenti e impostazioni applicative.",cta:"Parliamo di un progetto concreto"},
        Translated{slug:"mongodb",lang:"de",title:"MongoDB + PostgreSQL Datensysteme",eyebrow:"Datenschicht",summary:"Praktisches Design von Dokumenten- und relationalen Datenbanken, Indizierung, Migrationen, Backups und Anwendungsintegration.",glance:"",body:"<p class=\"lead\">Wir wählen die Datenbank passend zum Produkt, statt jeden Workflow in ein einziges Modell zu zwingen.</p><h2>MongoDB</h2><p>Gut geeignet für sich entwickelnde Inhalte und dokumentenförmige operative Daten, wenn Schema- und Indexdisziplin eingehalten wird.</p><h2>PostgreSQL</h2><p>Gut geeignet für relationale Workflows, Berichte, Constraints und transaktionsintensive Systeme.</p><h2>Produktionsgrundlagen</h2><p>Zugriff mit minimalen Rechten, Migrationen, Indizes, verschlüsselte Backups, Wiederherstellungstests und Query-Monitoring gehören zur Lieferung.</p>",seo_title:"MongoDB | Italy Developers",seo_description:"Dokumentenorientierte Speicherung für sich entwickelnde Inhalte, operative Datensätze, Anfragen, Kommentare und Anwendungseinstellungen.",cta:"Besprechen Sie ein konkretes Projekt"},
        Translated{slug:"mongodb",lang:"fr",title:"Systèmes de données MongoDB + PostgreSQL",eyebrow:"Couche de données",summary:"Conception pratique de bases de données documentaires et relationnelles, indexation, migrations, sauvegardes et intégration applicative.",glance:"",body:"<p class=\"lead\">Nous choisissons la base de données en fonction du produit plutôt que de forcer chaque flux de travail dans un seul modèle.</p><h2>MongoDB</h2><p>Bien adapté au contenu évolutif et aux données opérationnelles en forme de document, lorsque la discipline de schéma et d'index est maintenue.</p><h2>PostgreSQL</h2><p>Bien adapté aux flux de travail relationnels, au reporting, aux contraintes et aux systèmes à forte charge transactionnelle.</p><h2>Bases de la production</h2><p>Accès au moindre privilège, migrations, index, sauvegardes chiffrées, tests de restauration et surveillance des requêtes font partie de la livraison.</p>",seo_title:"MongoDB | Italy Developers",seo_description:"Stockage orienté document pour contenu évolutif, registres opérationnels, demandes, commentaires et paramètres applicatifs.",cta:"Discutons d'un projet concret"},
        Translated{slug:"mongodb",lang:"pt",title:"Sistemas de dados MongoDB + PostgreSQL",eyebrow:"Camada de dados",summary:"Design prático de bancos de dados de documentos e relacionais, indexação, migrações, backups e integração de aplicações.",glance:"",body:"<p class=\"lead\">Escolhemos o banco de dados em torno do produto, em vez de forçar cada fluxo de trabalho em um único modelo.</p><h2>MongoDB</h2><p>Uma boa opção para conteúdo em evolução e dados operacionais em formato de documento, quando a disciplina de esquema e índices é mantida.</p><h2>PostgreSQL</h2><p>Uma boa opção para fluxos de trabalho relacionais, relatórios, restrições e sistemas com muita carga transacional.</p><h2>Fundamentos de produção</h2><p>Acesso de privilégio mínimo, migrações, índices, backups criptografados, testes de restauração e monitoramento de consultas fazem parte da entrega.</p>",seo_title:"MongoDB | Italy Developers",seo_description:"Armazenamento orientado a documentos para conteúdo em evolução, registros operacionais, solicitações, comentários e configurações de aplicação.",cta:"Vamos falar sobre um projeto concreto"},

        Translated{slug:"docker-deployment",lang:"it",title:"Docker e Compose",eyebrow:"Deployment",summary:"Build multi-stage riproducibili, servizi isolati, storage persistente, health check e configurazione di produzione.",glance:"",body:"<p class=\"lead\">Confezioniamo le applicazioni con build Docker ripetibili e configurazione runtime esplicita.</p><h2>Pratiche di produzione</h2><ul><li>Container applicativi non-root e in sola lettura</li><li>Volumi persistenti per database e upload</li><li>Controlli di prontezza del servizio e policy di riavvio</li><li>Valori segreti tenuti fuori dal controllo versione</li><li>Log limitati e passaggi di backup documentati</li></ul>",seo_title:"Docker e Compose | Italy Developers",seo_description:"Build multi-stage riproducibili, servizi isolati, storage persistente, health check e configurazione di produzione.",cta:"Parliamo di un progetto concreto"},
        Translated{slug:"docker-deployment",lang:"de",title:"Docker und Compose",eyebrow:"Deployment",summary:"Reproduzierbare Multi-Stage-Builds, isolierte Dienste, persistenter Speicher, Health-Checks und Produktionskonfiguration.",glance:"",body:"<p class=\"lead\">Wir verpacken Anwendungen mit wiederholbaren Docker-Builds und expliziter Laufzeitkonfiguration.</p><h2>Produktionspraktiken</h2><ul><li>Non-root, schreibgeschützte Anwendungscontainer</li><li>Persistente Datenbank- und Upload-Volumes</li><li>Service-Readiness-Checks und Neustart-Richtlinien</li><li>Geheimwerte außerhalb der Versionskontrolle</li><li>Begrenzte Logs und dokumentierte Backup-Schritte</li></ul>",seo_title:"Docker und Compose | Italy Developers",seo_description:"Reproduzierbare Multi-Stage-Builds, isolierte Dienste, persistenter Speicher, Health-Checks und Produktionskonfiguration.",cta:"Besprechen Sie ein konkretes Projekt"},
        Translated{slug:"docker-deployment",lang:"fr",title:"Docker et Compose",eyebrow:"Déploiement",summary:"Builds multi-étapes reproductibles, services isolés, stockage persistant, vérifications de santé et configuration de production.",glance:"",body:"<p class=\"lead\">Nous packageons les applications avec des builds Docker reproductibles et une configuration d'exécution explicite.</p><h2>Pratiques de production</h2><ul><li>Conteneurs applicatifs non-root et en lecture seule</li><li>Volumes persistants pour base de données et téléversements</li><li>Vérifications de disponibilité du service et politiques de redémarrage</li><li>Valeurs secrètes gardées hors du contrôle de version</li><li>Logs bornés et étapes de sauvegarde documentées</li></ul>",seo_title:"Docker et Compose | Italy Developers",seo_description:"Builds multi-étapes reproductibles, services isolés, stockage persistant, vérifications de santé et configuration de production.",cta:"Discutons d'un projet concret"},
        Translated{slug:"docker-deployment",lang:"pt",title:"Docker e Compose",eyebrow:"Implantação",summary:"Builds multi-estágio reproduzíveis, serviços isolados, armazenamento persistente, verificações de saúde e configuração de produção.",glance:"",body:"<p class=\"lead\">Empacotamos aplicações com builds Docker repetíveis e configuração explícita de tempo de execução.</p><h2>Práticas de produção</h2><ul><li>Containers de aplicação não-root e somente leitura</li><li>Volumes persistentes de banco de dados e upload</li><li>Verificações de prontidão de serviço e políticas de reinício</li><li>Valores secretos mantidos fora do controle de versão</li><li>Logs limitados e etapas de backup documentadas</li></ul>",seo_title:"Docker e Compose | Italy Developers",seo_description:"Builds multi-estágio reproduzíveis, serviços isolados, armazenamento persistente, verificações de saúde e configuração de produção.",cta:"Vamos falar sobre um projeto concreto"},

        Translated{slug:"html-css-javascript",lang:"it",title:"React, Next.js + React Native",eyebrow:"Fondamenti frontend",summary:"Interfacce web e mobile responsive usando React, Next.js, React Native e fondamenta web accessibili.",glance:"",body:"<p class=\"lead\">Costruiamo le interfacce intorno al percorso utente, poi scegliamo il modello di consegna più leggero adatto.</p><h2>Interfacce di prodotto</h2><ul><li>Dashboard React e applicazioni interattive</li><li>Siti web Next.js e prodotti full-stack</li><li>Applicazioni mobili React Native</li><li>HTML semantico, CSS moderno, TypeScript e form accessibili</li></ul><p>Per pagine pubbliche ricche di contenuto possiamo raccomandare il rendering lato server; per workflow ricchi usiamo frontend basati su componenti dove aggiungono valore reale.</p>",seo_title:"HTML, CSS e JavaScript | Italy Developers",seo_description:"Interfacce semantiche accessibili, layout responsive e comportamento del browser mirato senza peso frontend inutile.",cta:"Parliamo di un progetto concreto"},
        Translated{slug:"html-css-javascript",lang:"de",title:"React, Next.js + React Native",eyebrow:"Frontend-Grundlagen",summary:"Responsive Web- und Mobile-Oberflächen mit React, Next.js, React Native und barrierefreien Web-Grundlagen.",glance:"",body:"<p class=\"lead\">Wir bauen Oberflächen um die Nutzerreise herum und wählen dann das leichteste passende Auslieferungsmodell.</p><h2>Produktoberflächen</h2><ul><li>React-Dashboards und interaktive Anwendungen</li><li>Next.js-Websites und Full-Stack-Produkte</li><li>React-Native-Mobile-Anwendungen</li><li>Semantisches HTML, modernes CSS, TypeScript und barrierefreie Formulare</li></ul><p>Für inhaltsreiche öffentliche Seiten empfehlen wir oft serverseitiges Rendering; für umfangreiche Workflows nutzen wir komponentenbasierte Frontends, wo sie echten Wert bringen.</p>",seo_title:"HTML, CSS und JavaScript | Italy Developers",seo_description:"Barrierefreie semantische Oberflächen, responsive Layouts und fokussiertes Browserverhalten ohne unnötiges Frontend-Gewicht.",cta:"Besprechen Sie ein konkretes Projekt"},
        Translated{slug:"html-css-javascript",lang:"fr",title:"React, Next.js + React Native",eyebrow:"Fondamentaux frontend",summary:"Interfaces web et mobiles responsives utilisant React, Next.js, React Native et des fondations web accessibles.",glance:"",body:"<p class=\"lead\">Nous construisons les interfaces autour du parcours utilisateur, puis choisissons le modèle de livraison le plus léger adapté.</p><h2>Interfaces produit</h2><ul><li>Tableaux de bord React et applications interactives</li><li>Sites web Next.js et produits full-stack</li><li>Applications mobiles React Native</li><li>HTML sémantique, CSS moderne, TypeScript et formulaires accessibles</li></ul><p>Pour les pages publiques riches en contenu, nous pouvons recommander le rendu côté serveur ; pour les flux de travail riches, nous utilisons des frontends à base de composants là où ils apportent une valeur réelle.</p>",seo_title:"HTML, CSS et JavaScript | Italy Developers",seo_description:"Interfaces sémantiques accessibles, mises en page responsives et comportement de navigateur ciblé sans poids frontend inutile.",cta:"Discutons d'un projet concret"},
        Translated{slug:"html-css-javascript",lang:"pt",title:"React, Next.js + React Native",eyebrow:"Fundamentos de frontend",summary:"Interfaces web e móveis responsivas usando React, Next.js, React Native e fundamentos web acessíveis.",glance:"",body:"<p class=\"lead\">Construímos interfaces em torno da jornada do usuário e então escolhemos o modelo de entrega mais leve e adequado.</p><h2>Interfaces de produto</h2><ul><li>Painéis React e aplicações interativas</li><li>Sites Next.js e produtos full-stack</li><li>Aplicações móveis React Native</li><li>HTML semântico, CSS moderno, TypeScript e formulários acessíveis</li></ul><p>Para páginas públicas ricas em conteúdo, podemos recomendar renderização no servidor; para fluxos de trabalho ricos, usamos frontends baseados em componentes onde agregam valor real.</p>",seo_title:"HTML, CSS e JavaScript | Italy Developers",seo_description:"Interfaces semânticas acessíveis, layouts responsivos e comportamento de navegador focado sem peso desnecessário de frontend.",cta:"Vamos falar sobre um projeto concreto"},

        Translated{slug:"flet-python",lang:"it",title:"Flet per interfacce Python",eyebrow:"UI Python",summary:"Interfacce Python in stile Material per dashboard responsive, form e strumenti interni che possono puntare a desktop o web.",glance:"",body:"<p class=\"lead\">Flet ci permette di costruire interfacce operative in Python mantenendo componenti, routing, temi e servizi ben separati.</p><h2>Usi realistici</h2><p>Dashboard admin, tabelle ricercabili, form interni, impostazioni, strumenti in stile chat e utility aziendali connesse via API.</p>",seo_title:"Flet per interfacce Python | Italy Developers",seo_description:"Interfacce Python in stile Material per dashboard responsive, form e strumenti interni che possono puntare a desktop o web.",cta:"Parliamo di un progetto concreto"},
        Translated{slug:"flet-python",lang:"de",title:"Flet für Python-Oberflächen",eyebrow:"Python-UI",summary:"Python-Oberflächen im Material-Stil für responsive Dashboards, Formulare und interne Tools, die Desktop oder Web ansprechen können.",glance:"",body:"<p class=\"lead\">Flet lässt uns operative Oberflächen in Python bauen und dabei Komponenten, Routing, Themes und Dienste sauber getrennt halten.</p><h2>Realistische Anwendungen</h2><p>Admin-Dashboards, durchsuchbare Tabellen, interne Formulare, Einstellungen, chat-artige Tools und API-verbundene Geschäftsutilities.</p>",seo_title:"Flet für Python-Oberflächen | Italy Developers",seo_description:"Python-Oberflächen im Material-Stil für responsive Dashboards, Formulare und interne Tools, die Desktop oder Web ansprechen können.",cta:"Besprechen Sie ein konkretes Projekt"},
        Translated{slug:"flet-python",lang:"fr",title:"Flet pour interfaces Python",eyebrow:"UI Python",summary:"Interfaces Python de style Material pour tableaux de bord responsives, formulaires et outils internes ciblant le bureau ou le web.",glance:"",body:"<p class=\"lead\">Flet nous permet de construire des interfaces opérationnelles en Python tout en gardant composants, routage, thèmes et services proprement séparés.</p><h2>Usages réalistes</h2><p>Tableaux de bord admin, tables consultables, formulaires internes, paramètres, outils de type chat et utilitaires métier connectés par API.</p>",seo_title:"Flet pour interfaces Python | Italy Developers",seo_description:"Interfaces Python de style Material pour tableaux de bord responsives, formulaires et outils internes ciblant le bureau ou le web.",cta:"Discutons d'un projet concret"},
        Translated{slug:"flet-python",lang:"pt",title:"Flet para interfaces Python",eyebrow:"UI Python",summary:"Interfaces Python em estilo Material para painéis responsivos, formulários e ferramentas internas que podem visar desktop ou web.",glance:"",body:"<p class=\"lead\">O Flet nos permite construir interfaces operacionais em Python mantendo componentes, roteamento, temas e serviços bem separados.</p><h2>Usos realistas</h2><p>Painéis admin, tabelas pesquisáveis, formulários internos, configurações, ferramentas estilo chat e utilitários empresariais conectados via API.</p>",seo_title:"Flet para interfaces Python | Italy Developers",seo_description:"Interfaces Python em estilo Material para painéis responsivos, formulários e ferramentas internas que podem visar desktop ou web.",cta:"Vamos falar sobre um projeto concreto"},

        Translated{slug:"git-github-ci",lang:"it",title:"Workflow Git, GitHub e CI",eyebrow:"Workflow di ingegneria",summary:"Controllo di versione verificabile, controlli riproducibili e consegna tracciabile per lo sviluppo di applicazioni e pacchetti.",glance:"",body:"<p class=\"lead\">Cronologia del codice sorgente, branch mirati, pull request e controlli di compilazione automatizzati rendono le modifiche più facili da rivedere e recuperare.</p><h2>Pratica di consegna</h2><p>Teniamo i segreti fuori dai commit, documentiamo i passaggi di release e validiamo le immagini di produzione prima del deployment.</p>",seo_title:"Workflow Git, GitHub e CI | Italy Developers",seo_description:"Controllo di versione verificabile, controlli riproducibili e consegna tracciabile per lo sviluppo di applicazioni e pacchetti.",cta:"Parliamo di un progetto concreto"},
        Translated{slug:"git-github-ci",lang:"de",title:"Git-, GitHub- und CI-Workflows",eyebrow:"Engineering-Workflow",summary:"Überprüfbare Versionskontrolle, reproduzierbare Prüfungen und nachvollziehbare Auslieferung für die Entwicklung von Anwendungen und Paketen.",glance:"",body:"<p class=\"lead\">Quellcode-Historie, fokussierte Branches, Pull Requests und automatisierte Kompilierungsprüfungen machen Änderungen leichter überprüfbar und wiederherstellbar.</p><h2>Lieferpraxis</h2><p>Wir halten Geheimnisse aus Commits heraus, dokumentieren Release-Schritte und validieren Produktions-Images vor dem Deployment.</p>",seo_title:"Git-, GitHub- und CI-Workflows | Italy Developers",seo_description:"Überprüfbare Versionskontrolle, reproduzierbare Prüfungen und nachvollziehbare Auslieferung für die Entwicklung von Anwendungen und Paketen.",cta:"Besprechen Sie ein konkretes Projekt"},
        Translated{slug:"git-github-ci",lang:"fr",title:"Workflows Git, GitHub et CI",eyebrow:"Workflow d'ingénierie",summary:"Contrôle de version vérifiable, vérifications reproductibles et livraison traçable pour le développement d'applications et de paquets.",glance:"",body:"<p class=\"lead\">L'historique des sources, les branches ciblées, les pull requests et les vérifications de compilation automatisées facilitent la revue et la récupération des changements.</p><h2>Pratique de livraison</h2><p>Nous gardons les secrets hors des commits, documentons les étapes de release et validons les images de production avant le déploiement.</p>",seo_title:"Workflows Git, GitHub et CI | Italy Developers",seo_description:"Contrôle de version vérifiable, vérifications reproductibles et livraison traçable pour le développement d'applications et de paquets.",cta:"Discutons d'un projet concret"},
        Translated{slug:"git-github-ci",lang:"pt",title:"Fluxos de trabalho Git, GitHub e CI",eyebrow:"Fluxo de engenharia",summary:"Controle de versão revisável, verificações reproduzíveis e entrega rastreável para o desenvolvimento de aplicações e pacotes.",glance:"",body:"<p class=\"lead\">Histórico de código-fonte, branches focadas, pull requests e verificações de compilação automatizadas tornam as mudanças mais fáceis de revisar e recuperar.</p><h2>Prática de entrega</h2><p>Mantemos segredos fora dos commits, documentamos etapas de lançamento e validamos imagens de produção antes da implantação.</p>",seo_title:"Fluxos de trabalho Git, GitHub e CI | Italy Developers",seo_description:"Controle de versão revisável, verificações reproduzíveis e entrega rastreável para o desenvolvimento de aplicações e pacotes.",cta:"Vamos falar sobre um projeto concreto"},
    ];
    apply_translations(db, "tech", &rows).await
}

async fn apply_translations_insight_v1(db: &Database) -> Result<(), AppError> {
    let rows: Vec<Translated> = vec![
        Translated{slug:"quanto-costa-un-sito-web-in-italia",lang:"it",title:"Quanto dovrebbe costare un sito web per piccole imprese in Italia?",eyebrow:"Guida all'acquisto",summary:"Un framework trasparente per definire l'ambito e confrontare le proposte, senza fingere che esista un prezzo universale.",glance:"Cinque domande da fare prima di confrontare due preventivi di siti web fianco a fianco, non un listino prezzi.",body:"<p class=\"lead\">Il prezzo segue ambito, rischio e responsabilità. Una brochure di cinque pagine assemblata da testi forniti è un prodotto diverso da un sito multilingua con ricerca originale, fotografia, prenotazioni e migrazione.</p><h2>Usa gli intervalli come orientamento</h2><p>I prezzi di freelance e studi variano molto per regione ed esperienza. Invece di trattare un numero come una garanzia di mercato, chiedi quale lavoro è incluso: discovery, scrittura, design, sviluppo, accessibilità, SEO, analytics, test e supporto.</p><div class=\"fact-grid\"><p><strong>Lancio essenziale</strong><br>Pagine mirate, asset forniti</p><p><strong>Build su misura</strong><br>Ricerca, contenuti e integrazioni</p></div><h2>Domande a cui ogni proposta dovrebbe rispondere</h2><ul><li>Chi possiede dominio, codice, design e account?</li><li>Quanti round di revisione e template di pagina sono inclusi?</li><li>Testi, traduzioni, fotografia e revisione legale sono inclusi?</li><li>Quali costi ricorrenti di piattaforma, plugin e manutenzione si applicano?</li><li>Come vengono testati accessibilità, prestazioni e backup?</li></ul><h2>Scegli prima il lavoro commerciale</h2><p>Se la priorità sono richieste qualificate, investi in chiarezza del servizio, prove e un percorso di contatto solido. Se la priorità sono vendite dirette, la configurazione operativa e i dati prodotto meritano più budget dell'animazione.</p><h3>Confronta cose comparabili</h3><p>Chiedi a ogni fornitore di separare il lancio indispensabile dalle fasi opzionali. Un primo rilascio più piccolo con misurazione è spesso più sicuro di un'ampia wishlist fissa.</p>",seo_title:"Quanto dovrebbe costare un sito web per piccole imprese in Italia? | Italy Developers",seo_description:"Un framework trasparente per definire l'ambito e confrontare le proposte, senza fingere che esista un prezzo universale.",cta:"Richiedi una proposta concreta"},
        Translated{slug:"quanto-costa-un-sito-web-in-italia",lang:"de",title:"Was sollte eine Kleinunternehmens-Website in Italien kosten?",eyebrow:"Käuferleitfaden",summary:"Ein transparentes Rahmenwerk zur Festlegung des Umfangs und zum Vergleich von Angeboten — ohne so zu tun, als gäbe es einen universellen Preis.",glance:"Fünf Fragen, die man vor dem direkten Vergleich zweier Website-Angebote stellen sollte, keine Preisliste.",body:"<p class=\"lead\">Der Preis folgt Umfang, Risiko und Verantwortung. Eine fünfseitige Broschüre aus geliefertem Text ist ein anderes Produkt als eine mehrsprachige Website mit Originalrecherche, Fotografie, Buchung und Migration.</p><h2>Bereiche als Orientierung nutzen</h2><p>Freelancer- und Studiopreise variieren stark nach Region und Erfahrung. Statt eine Zahl als Marktgarantie zu behandeln, fragen Sie, welche Arbeit enthalten ist: Discovery, Texten, Design, Entwicklung, Barrierefreiheit, SEO, Analytics, Tests und Support.</p><div class=\"fact-grid\"><p><strong>Schlanker Start</strong><br>Fokussierte Seiten, gelieferte Assets</p><p><strong>Individueller Bau</strong><br>Recherche, Inhalte und Integrationen</p></div><h2>Fragen, die jedes Angebot beantworten sollte</h2><ul><li>Wem gehören Domain, Code, Design und Konten?</li><li>Wie viele Revisionsrunden und Seitenvorlagen sind enthalten?</li><li>Sind Texte, Übersetzungen, Fotografie und Rechtsprüfung enthalten?</li><li>Welche wiederkehrenden Plattform-, Plugin- und Wartungskosten fallen an?</li><li>Wie werden Barrierefreiheit, Leistung und Backups getestet?</li></ul><h2>Zuerst den kommerziellen Auftrag wählen</h2><p>Wenn qualifizierte Anfragen Priorität haben, investieren Sie in Klarheit des Angebots, Belege und einen starken Kontaktweg. Wenn Direktverkauf Priorität hat, verdienen operative Einrichtung und Produktdaten mehr Budget als Animation.</p><h3>Gleiches mit Gleichem vergleichen</h3><p>Bitten Sie jeden Anbieter, den unverzichtbaren Start von optionalen Phasen zu trennen. Eine kleinere erste Version mit Messung ist oft sicherer als eine große feste Wunschliste.</p>",seo_title:"Was sollte eine Kleinunternehmens-Website in Italien kosten? | Italy Developers",seo_description:"Ein transparentes Rahmenwerk zur Festlegung des Umfangs und zum Vergleich von Angeboten — ohne so zu tun, als gäbe es einen universellen Preis.",cta:"Fordern Sie einen konkreten Vorschlag an"},
        Translated{slug:"quanto-costa-un-sito-web-in-italia",lang:"fr",title:"Combien devrait coûter un site web pour petite entreprise en Italie ?",eyebrow:"Guide d'achat",summary:"Un cadre transparent pour définir le périmètre et comparer les propositions, sans prétendre qu'il existe un prix universel.",glance:"Cinq questions à poser avant de comparer deux devis de site web côte à côte, pas une liste de prix.",body:"<p class=\"lead\">Le prix suit le périmètre, le risque et la responsabilité. Une brochure de cinq pages assemblée à partir de textes fournis est un produit différent d'un site multilingue avec recherche originale, photographie, réservation et migration.</p><h2>Utiliser les fourchettes comme orientation</h2><p>Les tarifs des indépendants et studios varient largement selon la région et l'expérience. Plutôt que de traiter un chiffre comme une garantie de marché, demandez quel travail est inclus : découverte, rédaction, design, développement, accessibilité, SEO, analytics, tests et support.</p><div class=\"fact-grid\"><p><strong>Lancement léger</strong><br>Pages ciblées, ressources fournies</p><p><strong>Build sur mesure</strong><br>Recherche, contenu et intégrations</p></div><h2>Questions auxquelles chaque proposition devrait répondre</h2><ul><li>Qui possède le domaine, le code, le design et les comptes ?</li><li>Combien de cycles de révision et de modèles de page sont inclus ?</li><li>Les textes, traductions, photographie et révision légale sont-ils inclus ?</li><li>Quels coûts récurrents de plateforme, plugin et maintenance s'appliquent ?</li><li>Comment l'accessibilité, la performance et les sauvegardes sont-elles testées ?</li></ul><h2>Choisir d'abord le travail commercial</h2><p>Si la priorité est les demandes qualifiées, investissez dans la clarté du service, les preuves et un parcours de contact solide. Si la priorité est la vente directe, la configuration opérationnelle et les données produit méritent plus de budget que l'animation.</p><h3>Comparer ce qui est comparable</h3><p>Demandez à chaque fournisseur de séparer le lancement indispensable des phases optionnelles. Une première version plus petite avec mesure est souvent plus sûre qu'une grande liste de souhaits fixe.</p>",seo_title:"Combien devrait coûter un site web pour petite entreprise en Italie ? | Italy Developers",seo_description:"Un cadre transparent pour définir le périmètre et comparer les propositions, sans prétendre qu'il existe un prix universel.",cta:"Demandez une proposition concrète"},
        Translated{slug:"quanto-costa-un-sito-web-in-italia",lang:"pt",title:"Quanto deveria custar um site para pequenas empresas na Itália?",eyebrow:"Guia do comprador",summary:"Um framework transparente para definir o escopo e comparar propostas, sem fingir que existe um preço universal.",glance:"Cinco perguntas a fazer antes de comparar dois orçamentos de sites lado a lado, não uma lista de preços.",body:"<p class=\"lead\">O preço segue escopo, risco e responsabilidade. Uma brochura de cinco páginas montada a partir de texto fornecido é um produto diferente de um site multilíngue com pesquisa original, fotografia, reservas e migração.</p><h2>Use faixas como orientação</h2><p>Os preços de freelancers e estúdios variam muito por região e experiência. Em vez de tratar um número como garantia de mercado, pergunte que trabalho está incluído: descoberta, redação, design, desenvolvimento, acessibilidade, SEO, analytics, testes e suporte.</p><div class=\"fact-grid\"><p><strong>Lançamento enxuto</strong><br>Páginas focadas, ativos fornecidos</p><p><strong>Build sob medida</strong><br>Pesquisa, conteúdo e integrações</p></div><h2>Perguntas que toda proposta deveria responder</h2><ul><li>Quem possui o domínio, código, design e contas?</li><li>Quantas rodadas de revisão e templates de página estão incluídos?</li><li>Texto, traduções, fotografia e revisão legal estão incluídos?</li><li>Quais custos recorrentes de plataforma, plugin e manutenção se aplicam?</li><li>Como acessibilidade, desempenho e backups são testados?</li></ul><h2>Escolha primeiro o trabalho comercial</h2><p>Se a prioridade são solicitações qualificadas, invista em clareza de serviço, evidências e um caminho de contato forte. Se a prioridade são vendas diretas, configuração operacional e dados de produto merecem mais orçamento que animação.</p><h3>Compare o que é comparável</h3><p>Peça a cada fornecedor que separe o lançamento essencial das fases opcionais. Um primeiro lançamento menor com medição costuma ser mais seguro que uma grande lista de desejos fixa.</p>",seo_title:"Quanto deveria custar um site para pequenas empresas na Itália? | Italy Developers",seo_description:"Um framework transparente para definir o escopo e comparar propostas, sem fingir que existe um preço universal.",cta:"Solicite uma proposta concreta"},

        Translated{slug:"come-scegliere-un-partner-web-in-italia",lang:"it",title:"Come scegliere un partner web in Italia senza rimpianti",eyebrow:"Guida all'acquisto",summary:"Un framework di valutazione pratico per confrontare freelance, agenzie e piattaforme prima di firmare qualsiasi cosa.",glance:"Cosa controllare prima di firmare, basato sui passaggi di consegna che vanno male quando una partnership finisce male.",body:"<p class=\"lead\">Il preventivo più economico e quello più costoso possono promettere lo stesso risultato. Ciò che davvero predice un buon esito è il processo, la proprietà e la comunicazione, non il logo sulla proposta.</p><h2>Chiedi della proprietà prima di ogni altra cosa</h2><p>Conferma per iscritto che possiederai dominio, account di hosting, codice sorgente, contenuti e qualsiasi account di terze parti aperto per tuo conto. Un partner che resiste a cedere l'accesso admin è un partner che farai fatica a lasciare in seguito.</p><div class=\"fact-grid\"><p><strong>Buon segno</strong><br>Accesso ed export ceduti come prassi standard</p><p><strong>Segnale d'allarme</strong><br>\"Ce ne occupiamo noi\" senza un piano di consegna</p></div><h2>Confronta il processo, non solo il prezzo</h2><ul><li>Come viene definito l'ambito e cosa succede quando cambia?</li><li>Chi scrive i contenuti, e in quale lingua?</li><li>Quante demo funzionanti vedrai prima del lancio?</li><li>Qual è il piano per accessibilità, prestazioni e test?</li><li>Cosa succede dopo il lancio: il supporto è definito o aperto?</li></ul><h2>Leggi il portfolio come un cliente, non come uno spettatore</h2><p>Apri esempi reali su un telefono, con una connessione lenta se possibile. Cerca dettagli aziendali genuini: prezzi, orari, fotografia onesta, form funzionanti, non solo uno screenshot patinato della homepage.</p><h3>Una breve chiamata di referenza vale più di una lunga presentazione</h3><p>Fai a un cliente precedente una domanda diretta: assumerebbe di nuovo questo partner, e perché sì o no. La risposta di solito ti dice più della presentazione stessa.</p>",seo_title:"Come scegliere un partner web in Italia senza rimpianti | Italy Developers",seo_description:"Un framework di valutazione pratico per confrontare freelance, agenzie e piattaforme prima di firmare qualsiasi cosa.",cta:"Richiedi una proposta concreta"},
        Translated{slug:"come-scegliere-un-partner-web-in-italia",lang:"de",title:"Wie man in Italien einen Web-Partner ohne Reue auswählt",eyebrow:"Käuferleitfaden",summary:"Ein praktisches Bewertungsrahmenwerk zum Vergleich von Freelancern, Agenturen und Plattformen, bevor Sie etwas unterschreiben.",glance:"Was vor der Unterschrift zu prüfen ist, basierend auf Übergaben, die schiefgehen, wenn eine Partnerschaft schlecht endet.",body:"<p class=\"lead\">Das billigste und das teuerste Angebot können dasselbe Ergebnis versprechen. Was ein gutes Ergebnis tatsächlich vorhersagt, sind Prozess, Eigentum und Kommunikation — nicht das Logo auf dem Angebot.</p><h2>Fragen Sie zuerst nach Eigentum</h2><p>Bestätigen Sie schriftlich, dass Sie Domain, Hosting-Konto, Quellcode, Inhalte und alle in Ihrem Namen eröffneten Drittanbieterkonten besitzen werden. Ein Partner, der sich gegen die Übergabe des Admin-Zugangs sträubt, ist ein Partner, den Sie später schwer verlassen können.</p><div class=\"fact-grid\"><p><strong>Gutes Zeichen</strong><br>Zugang und Exporte werden standardmäßig übergeben</p><p><strong>Warnzeichen</strong><br>\"Das übernehmen wir für Sie\" ohne Übergabeplan</p></div><h2>Prozess vergleichen, nicht nur Preis</h2><ul><li>Wie wird der Umfang definiert, und was passiert, wenn er sich ändert?</li><li>Wer schreibt die Inhalte, und in welcher Sprache?</li><li>Wie viele funktionierende Demos sehen Sie vor dem Start?</li><li>Was ist der Plan für Barrierefreiheit, Leistung und Tests?</li><li>Was passiert nach dem Start — ist Support begrenzt oder offen?</li></ul><h2>Das Portfolio wie ein Kunde lesen, nicht wie ein Zuschauer</h2><p>Öffnen Sie echte Beispiele auf einem Handy, wenn möglich mit langsamer Verbindung. Suchen Sie nach echten geschäftlichen Details: Preise, Öffnungszeiten, ehrliche Fotografie, funktionierende Formulare — nicht nur einen polierten Startseiten-Screenshot.</p><h3>Ein kurzer Referenzanruf ist mehr wert als eine lange Präsentation</h3><p>Stellen Sie einem früheren Kunden eine direkte Frage: Würde er diesen Partner wieder beauftragen, und warum oder warum nicht. Die Antwort sagt meist mehr aus als das Pitch selbst.</p>",seo_title:"Wie man in Italien einen Web-Partner ohne Reue auswählt | Italy Developers",seo_description:"Ein praktisches Bewertungsrahmenwerk zum Vergleich von Freelancern, Agenturen und Plattformen, bevor Sie etwas unterschreiben.",cta:"Fordern Sie einen konkreten Vorschlag an"},
        Translated{slug:"come-scegliere-un-partner-web-in-italia",lang:"fr",title:"Comment choisir un partenaire web en Italie sans regret",eyebrow:"Guide d'achat",summary:"Un cadre d'évaluation pratique pour comparer freelances, agences et plateformes avant de signer quoi que ce soit.",glance:"Ce qu'il faut vérifier avant de signer, basé sur les transferts qui échouent quand un partenariat se termine mal.",body:"<p class=\"lead\">Le devis le moins cher et le plus cher peuvent promettre le même résultat. Ce qui prédit réellement un bon résultat, c'est le processus, la propriété et la communication — pas le logo sur la proposition.</p><h2>Demandez la propriété avant toute chose</h2><p>Confirmez par écrit que vous posséderez votre domaine, compte d'hébergement, code source, contenu et tout compte tiers ouvert en votre nom. Un partenaire qui résiste à céder l'accès admin est un partenaire que vous aurez du mal à quitter plus tard.</p><div class=\"fact-grid\"><p><strong>Bon signe</strong><br>Accès et exports cédés comme pratique standard</p><p><strong>Signal d'alerte</strong><br>« On s'occupe de ça pour vous » sans plan de transfert</p></div><h2>Comparez le processus, pas seulement le prix</h2><ul><li>Comment le périmètre est-il défini, et que se passe-t-il quand il change ?</li><li>Qui rédige le contenu, et dans quelle langue ?</li><li>Combien de démos fonctionnelles verrez-vous avant le lancement ?</li><li>Quel est le plan pour l'accessibilité, la performance et les tests ?</li><li>Que se passe-t-il après le lancement — le support est-il défini ou ouvert ?</li></ul><h2>Lisez le portfolio comme un client, pas comme un spectateur</h2><p>Ouvrez de vrais exemples sur un téléphone, avec une connexion lente si possible. Cherchez des détails commerciaux authentiques : prix, horaires, photographie honnête, formulaires fonctionnels — pas juste une capture d'écran soignée de la page d'accueil.</p><h3>Un court appel de référence vaut plus qu'une longue présentation</h3><p>Posez à un ancien client une question directe : embaucherait-il à nouveau ce partenaire, et pourquoi ou pourquoi pas. La réponse en dit généralement plus long que le pitch.</p>",seo_title:"Comment choisir un partenaire web en Italie sans regret | Italy Developers",seo_description:"Un cadre d'évaluation pratique pour comparer freelances, agences et plateformes avant de signer quoi que ce soit.",cta:"Demandez une proposition concrète"},
        Translated{slug:"come-scegliere-un-partner-web-in-italia",lang:"pt",title:"Como escolher um parceiro web na Itália sem arrependimentos",eyebrow:"Guia do comprador",summary:"Um framework prático de avaliação para comparar freelancers, agências e plataformas antes de assinar qualquer coisa.",glance:"O que verificar antes de assinar, com base nas transições que dão errado quando uma parceria termina mal.",body:"<p class=\"lead\">O orçamento mais barato e o mais caro podem prometer o mesmo resultado. O que realmente prevê um bom resultado é o processo, a propriedade e a comunicação — não o logotipo na proposta.</p><h2>Pergunte sobre propriedade antes de tudo</h2><p>Confirme por escrito que você será dono do domínio, conta de hospedagem, código-fonte, conteúdo e qualquer conta de terceiros aberta em seu nome. Um parceiro que resiste a entregar acesso admin é um parceiro que você terá dificuldade em deixar depois.</p><div class=\"fact-grid\"><p><strong>Bom sinal</strong><br>Acesso e exportações entregues como prática padrão</p><p><strong>Sinal de alerta</strong><br>\"Nós cuidamos disso para você\" sem plano de transição</p></div><h2>Compare processo, não apenas preço</h2><ul><li>Como o escopo é definido, e o que acontece quando ele muda?</li><li>Quem escreve o conteúdo, e em qual idioma?</li><li>Quantas demonstrações funcionais você verá antes do lançamento?</li><li>Qual é o plano para acessibilidade, desempenho e testes?</li><li>O que acontece após o lançamento — o suporte é definido ou aberto?</li></ul><h2>Leia o portfólio como um cliente, não como um espectador</h2><p>Abra exemplos reais em um celular, com conexão lenta se possível. Procure detalhes comerciais genuínos: preços, horários, fotografia honesta, formulários funcionais — não apenas uma captura de tela polida da página inicial.</p><h3>Uma breve ligação de referência vale mais que uma longa apresentação</h3><p>Faça a um cliente anterior uma pergunta direta: ele contrataria esse parceiro novamente, e por que sim ou não. A resposta geralmente diz mais do que a apresentação.</p>",seo_title:"Como escolher um parceiro web na Itália sem arrependimentos | Italy Developers",seo_description:"Um framework prático de avaliação para comparar freelancers, agências e plataformas antes de assinar qualquer coisa.",cta:"Solicite uma proposta concreta"},

        Translated{slug:"gdpr-cookie-base-sito-piccola-impresa",lang:"it",title:"GDPR, cookie e nozioni base sulla privacy per ogni sito di piccola impresa",eyebrow:"Nozioni di conformità",summary:"Una checklist di partenza pratica per siti di piccole imprese attenti alla privacy in Italia, non un sostituto della consulenza legale qualificata.",glance:"Una checklist di partenza, non consulenza legale, per titolari che devono avere le basi giuste prima di chiamare un avvocato.",body:"<p class=\"lead\">La maggior parte dei siti di piccole imprese raccoglie più dati personali di quanto i titolari immaginino: form di contatto, analytics, mappe integrate, widget di prenotazione. Fare le cose base correttamente è possibile senza un ufficio legale.</p><h2>Inizia con ciò che raccogli davvero</h2><p>Elenca ogni form, cookie, script ed embed di terze parti sul sito, e quali dati personali ciascuno tocca. Non puoi scrivere un'informativa privacy onesta, o configurare correttamente il consenso, senza questo inventario.</p><div class=\"fact-grid\"><p><strong>Fonti tipiche</strong><br>Form di contatto, analytics, mappe, widget di prenotazione, strumenti di chat</p><p><strong>Primo output</strong><br>Un inventario dati in linguaggio semplice</p></div><h2>Default pratici che integriamo</h2><ul><li>Nessun cookie non essenziale si attiva prima del consenso</li><li>Un'informativa privacy chiara e specifica al momento della raccolta dati</li><li>Minimizzazione dei dati: raccogli solo ciò che il processo richiede davvero</li><li>Un periodo di conservazione definito invece di archiviare richieste indefinitamente</li><li>HTTPS ovunque e gestione sicura degli invii archiviati</li></ul><h2>Dove finisce il lavoro di uno sviluppatore</h2><p>Possiamo implementare la gestione del consenso, minimizzare la raccolta dati e documentare cosa fa il sito con le informazioni personali. Se questa implementazione soddisfi i tuoi specifici obblighi legali è una domanda per un consulente privacy qualificato, in particolare se gestisci dati sensibili, operi oltre confine o lavori in un settore regolamentato.</p><h3>Trattalo come una base, non un certificato</h3><p>Un sito ben costruito rende la conformità raggiungibile. Non sostituisce una revisione legale adeguata per un'azienda con reale esposizione normativa.</p>",seo_title:"GDPR, cookie e nozioni base sulla privacy per ogni sito di piccola impresa | Italy Developers",seo_description:"Una checklist di partenza pratica per siti di piccole imprese attenti alla privacy in Italia, non un sostituto della consulenza legale qualificata.",cta:"Richiedi una proposta concreta"},
        Translated{slug:"gdpr-cookie-base-sito-piccola-impresa",lang:"de",title:"DSGVO, Cookies und Datenschutz-Grundlagen für jede Kleinunternehmens-Website",eyebrow:"Compliance-Grundlagen",summary:"Eine praktische Startcheckliste für datenschutzbewusste Kleinunternehmens-Websites in Italien — kein Ersatz für qualifizierte Rechtsberatung.",glance:"Eine Startcheckliste, keine Rechtsberatung, für Inhaber, die vor dem Anruf beim Anwalt die Grundlagen richtig brauchen.",body:"<p class=\"lead\">Die meisten Kleinunternehmens-Websites sammeln mehr personenbezogene Daten, als ihren Inhabern bewusst ist: Kontaktformulare, Analytics, eingebettete Karten, Buchungswidgets. Die Grundlagen richtig zu machen, ist ohne Rechtsabteilung erreichbar.</p><h2>Beginnen Sie mit dem, was Sie tatsächlich sammeln</h2><p>Listen Sie jedes Formular, Cookie, Skript und Drittanbieter-Embed auf der Website auf und welche personenbezogenen Daten jedes berührt. Ohne dieses Inventar können Sie keine ehrliche Datenschutzerklärung schreiben oder die Einwilligung korrekt konfigurieren.</p><div class=\"fact-grid\"><p><strong>Typische Quellen</strong><br>Kontaktformulare, Analytics, Karten, Buchungswidgets, Chat-Tools</p><p><strong>Erstes Ergebnis</strong><br>Ein Dateninventar in einfacher Sprache</p></div><h2>Praktische Standards, die wir einbauen</h2><ul><li>Keine nicht essenziellen Cookies werden vor Einwilligung ausgelöst</li><li>Ein klarer, spezifischer Datenschutzhinweis am Punkt der Datenerhebung</li><li>Datenminimierung — nur sammeln, was der Prozess tatsächlich braucht</li><li>Eine definierte Aufbewahrungsfrist statt unbegrenzter Speicherung von Anfragen</li><li>HTTPS überall und sichere Handhabung gespeicherter Einreichungen</li></ul><h2>Wo die Arbeit eines Entwicklers endet</h2><p>Wir können Einwilligungsmanagement implementieren, die Datenerhebung minimieren und dokumentieren, was die Website mit personenbezogenen Informationen tut. Ob diese Umsetzung Ihre spezifischen rechtlichen Pflichten erfüllt, ist eine Frage für einen qualifizierten Datenschutzberater, besonders wenn Sie sensible Daten verarbeiten, grenzüberschreitend tätig sind oder in einem regulierten Sektor arbeiten.</p><h3>Behandeln Sie dies als Grundlage, nicht als Zertifikat</h3><p>Eine gut gebaute Website macht Compliance erreichbar. Sie ersetzt keine ordentliche Rechtsprüfung für ein Unternehmen mit echtem regulatorischem Risiko.</p>",seo_title:"DSGVO, Cookies und Datenschutz-Grundlagen für jede Kleinunternehmens-Website | Italy Developers",seo_description:"Eine praktische Startcheckliste für datenschutzbewusste Kleinunternehmens-Websites in Italien — kein Ersatz für qualifizierte Rechtsberatung.",cta:"Fordern Sie einen konkreten Vorschlag an"},
        Translated{slug:"gdpr-cookie-base-sito-piccola-impresa",lang:"fr",title:"RGPD, cookies et bases de confidentialité pour tout site de petite entreprise",eyebrow:"Bases de conformité",summary:"Une checklist de départ pratique pour des sites de petites entreprises soucieux de la confidentialité en Italie — pas un substitut à un conseil juridique qualifié.",glance:"Une checklist de départ, pas un conseil juridique, pour les propriétaires qui ont besoin des bases avant d'appeler un avocat.",body:"<p class=\"lead\">La plupart des sites de petites entreprises collectent plus de données personnelles que leurs propriétaires ne le réalisent : formulaires de contact, analytics, cartes intégrées, widgets de réservation. Bien faire les bases de base est réalisable sans service juridique.</p><h2>Commencez par ce que vous collectez réellement</h2><p>Listez chaque formulaire, cookie, script et intégration tierce sur le site, et quelles données personnelles chacun touche. Vous ne pouvez pas rédiger un avis de confidentialité honnête, ni configurer correctement le consentement, sans cet inventaire.</p><div class=\"fact-grid\"><p><strong>Sources typiques</strong><br>Formulaires de contact, analytics, cartes, widgets de réservation, outils de chat</p><p><strong>Premier livrable</strong><br>Un inventaire de données en langage simple</p></div><h2>Défauts pratiques que nous intégrons</h2><ul><li>Aucun cookie non essentiel ne se déclenche avant le consentement</li><li>Un avis de confidentialité clair et spécifique au moment de la collecte de données</li><li>Minimisation des données — ne collecter que ce dont le processus a réellement besoin</li><li>Une période de conservation définie plutôt que de stocker les demandes indéfiniment</li><li>HTTPS partout et gestion sécurisée des soumissions stockées</li></ul><h2>Où s'arrête le travail d'un développeur</h2><p>Nous pouvons implémenter la gestion du consentement, minimiser la collecte de données et documenter ce que le site fait des informations personnelles. Savoir si cette mise en œuvre satisfait vos obligations légales spécifiques est une question pour un conseiller en confidentialité qualifié, en particulier si vous traitez des données sensibles, opérez à travers les frontières ou travaillez dans un secteur réglementé.</p><h3>Traitez cela comme une fondation, pas un certificat</h3><p>Un site bien construit rend la conformité atteignable. Il ne remplace pas une révision juridique appropriée pour une entreprise avec une réelle exposition réglementaire.</p>",seo_title:"RGPD, cookies et bases de confidentialité pour tout site de petite entreprise | Italy Developers",seo_description:"Une checklist de départ pratique pour des sites de petites entreprises soucieux de la confidentialité en Italie — pas un substitut à un conseil juridique qualifié.",cta:"Demandez une proposition concrète"},
        Translated{slug:"gdpr-cookie-base-sito-piccola-impresa",lang:"pt",title:"RGPD, cookies e noções básicas de privacidade que todo site de pequena empresa precisa",eyebrow:"Noções de conformidade",summary:"Uma checklist inicial prática para sites de pequenas empresas atentos à privacidade na Itália — não um substituto para aconselhamento jurídico qualificado.",glance:"Uma checklist inicial, não aconselhamento jurídico, para proprietários que precisam acertar o básico antes de ligar para um advogado.",body:"<p class=\"lead\">A maioria dos sites de pequenas empresas coleta mais dados pessoais do que seus proprietários percebem: formulários de contato, analytics, mapas incorporados, widgets de reserva. Acertar o básico é possível sem um departamento jurídico.</p><h2>Comece pelo que você realmente coleta</h2><p>Liste cada formulário, cookie, script e incorporação de terceiros no site, e quais dados pessoais cada um toca. Você não pode escrever um aviso de privacidade honesto, ou configurar o consentimento corretamente, sem esse inventário.</p><div class=\"fact-grid\"><p><strong>Fontes típicas</strong><br>Formulários de contato, analytics, mapas, widgets de reserva, ferramentas de chat</p><p><strong>Primeira entrega</strong><br>Um inventário de dados em linguagem simples</p></div><h2>Padrões práticos que incorporamos</h2><ul><li>Nenhum cookie não essencial dispara antes do consentimento</li><li>Um aviso de privacidade claro e específico no ponto de coleta de dados</li><li>Minimização de dados — coletar apenas o que o processo realmente precisa</li><li>Um período de retenção definido em vez de armazenar solicitações indefinidamente</li><li>HTTPS em todo lugar e tratamento seguro de envios armazenados</li></ul><h2>Onde termina o trabalho de um desenvolvedor</h2><p>Podemos implementar gestão de consentimento, minimizar a coleta de dados e documentar o que o site faz com informações pessoais. Se essa implementação satisfaz suas obrigações legais específicas é uma questão para um consultor de privacidade qualificado, especialmente se você lida com dados sensíveis, opera além-fronteiras ou trabalha em um setor regulamentado.</p><h3>Trate isso como uma base, não um certificado</h3><p>Um site bem construído torna a conformidade alcançável. Não substitui uma revisão jurídica adequada para uma empresa com exposição regulatória real.</p>",seo_title:"RGPD, cookies e noções básicas de privacidade que todo site de pequena empresa precisa | Italy Developers",seo_description:"Uma checklist inicial prática para sites de pequenas empresas atentos à privacidade na Itália — não um substituto para aconselhamento jurídico qualificado.",cta:"Solicite uma proposta concreta"},

        Translated{slug:"noleggiare-o-possedere-il-sito-web",lang:"it",title:"Noleggiare o possedere il sito web: builder di piattaforma confrontati con una build su misura",eyebrow:"Framework decisionale",summary:"Un confronto lucido tra builder di siti SaaS e una build su misura, basato su cosa controlli davvero.",glance:"Le domande esatte che distinguono un'azienda che dovrebbe noleggiare un builder da una che ha bisogno di una build su misura.",body:"<p class=\"lead\">Un abbonamento a un page-builder e un sito costruito su misura possono sembrare simili il giorno del lancio. La differenza emerge diciotto mesi dopo, quando ti serve qualcosa che la piattaforma non è mai stata progettata per fare.</p><h2>Cosa stai davvero scegliendo</h2><p>Un builder SaaS ti affitta una piattaforma: veloce da avviare, costo mensile prevedibile, ma il tuo sito vive dentro il sistema di qualcun altro, con limiti reali su struttura, integrazioni ed export dei dati.</p><p>Una build su misura costa di più in anticipo e ti dà un prodotto funzionante che possiedi interamente: il tuo codice, i tuoi dati, la tua scelta di hosting, e nessuna migrazione forzata in futuro.</p><div class=\"fact-grid\"><p><strong>I builder si adattano a</strong><br>Siti semplici, a basso rischio, con esigenze standard</p><p><strong>Il su misura si adatta a</strong><br>Siti strettamente legati a come opera davvero l'azienda</p></div><h2>Domande che rivelano la risposta giusta</h2><ul><li>L'azienda dipende da una logica specifica di prenotazione, catalogo o workflow?</li><li>Avrai bisogno di integrazioni che l'app store del builder non offre?</li><li>Cambiare piattaforma in seguito è un costo accettabile, o un rischio reale?</li><li>La velocità di pagina e la visibilità nelle ricerche influenzano materialmente il fatturato?</li><li>Chi deve modificare i contenuti quotidianamente, e quanto è tecnico?</li></ul><h2>Una via di mezzo ragionevole</h2><p>Alcune aziende lanciano in modo essenziale su un builder, dimostrano la domanda, poi commissionano una build su misura una volta che i requisiti sono reali invece che ipotetici. Questa sequenza è spesso più intelligente che indovinare in anticipo.</p><h3>Siamo onesti sul compromesso</h3><p>Costruiamo prodotti su misura perché è lì che aggiungiamo più valore, non perché un builder sia sempre la scelta sbagliata per un sito molto semplice.</p>",seo_title:"Noleggiare o possedere il sito web: builder di piattaforma confrontati con una build su misura | Italy Developers",seo_description:"Un confronto lucido tra builder di siti SaaS e una build su misura, basato su cosa controlli davvero.",cta:"Richiedi una proposta concreta"},
        Translated{slug:"noleggiare-o-possedere-il-sito-web",lang:"de",title:"Website mieten oder besitzen: Plattform-Baukästen im Vergleich zu einem individuellen Build",eyebrow:"Entscheidungsrahmen",summary:"Ein nüchterner Vergleich von SaaS-Website-Baukästen und einem individuellen Build, basierend darauf, was Sie tatsächlich kontrollieren.",glance:"Die genauen Fragen, die ein Unternehmen, das einen Baukasten mieten sollte, von einem unterscheiden, das einen individuellen Build braucht.",body:"<p class=\"lead\">Ein Page-Builder-Abo und eine individuell gebaute Website können am Starttag ähnlich aussehen. Der Unterschied zeigt sich achtzehn Monate später, wenn Sie etwas brauchen, wofür die Plattform nie entworfen wurde.</p><h2>Was Sie wirklich wählen</h2><p>Ein SaaS-Baukasten vermietet Ihnen eine Plattform: schnell zu starten, vorhersehbare monatliche Kosten, aber Ihre Website lebt im System eines anderen, mit echten Grenzen bei Struktur, Integrationen und Datenexport.</p><p>Ein individueller Build kostet im Voraus mehr und gibt Ihnen ein funktionierendes Produkt, das vollständig Ihnen gehört: Ihr Code, Ihre Daten, Ihre Hosting-Wahl, und keine erzwungene Migration später.</p><div class=\"fact-grid\"><p><strong>Baukästen passen zu</strong><br>Einfachen, risikoarmen Websites mit Standardbedarf</p><p><strong>Individuell passt zu</strong><br>Websites, die eng mit der tatsächlichen Arbeitsweise des Unternehmens verbunden sind</p></div><h2>Fragen, die die richtige Antwort offenbaren</h2><ul><li>Hängt das Unternehmen von einer bestimmten Buchungs-, Katalog- oder Workflow-Logik ab?</li><li>Benötigen Sie Integrationen, die der App-Store des Baukastens nicht bietet?</li><li>Ist ein späterer Plattformwechsel ein akzeptabler Kostenpunkt oder ein echtes Risiko?</li><li>Beeinflussen Seitengeschwindigkeit und Suchsichtbarkeit den Umsatz wesentlich?</li><li>Wer muss Inhalte täglich bearbeiten, und wie technisch versiert sind sie?</li></ul><h2>Ein vernünftiger Mittelweg</h2><p>Manche Unternehmen starten schlank mit einem Baukasten, beweisen die Nachfrage und beauftragen dann einen individuellen Build, sobald die Anforderungen real statt hypothetisch sind. Diese Reihenfolge ist oft klüger als von vornherein zu raten.</p><h3>Wir sind ehrlich über den Kompromiss</h3><p>Wir bauen individuelle Produkte, weil wir dort den meisten Wert schaffen — nicht weil ein Baukasten für eine sehr einfache Website immer die falsche Wahl ist.</p>",seo_title:"Website mieten oder besitzen: Plattform-Baukästen im Vergleich zu einem individuellen Build | Italy Developers",seo_description:"Ein nüchterner Vergleich von SaaS-Website-Baukästen und einem individuellen Build, basierend darauf, was Sie tatsächlich kontrollieren.",cta:"Fordern Sie einen konkreten Vorschlag an"},
        Translated{slug:"noleggiare-o-possedere-il-sito-web",lang:"fr",title:"Louer ou posséder votre site web : constructeurs de plateforme comparés à un build sur mesure",eyebrow:"Cadre de décision",summary:"Une comparaison lucide entre les constructeurs de sites SaaS et un build sur mesure, basée sur ce que vous contrôlez réellement.",glance:"Les questions exactes qui distinguent une entreprise qui devrait louer un constructeur de celle qui a besoin d'un build sur mesure.",body:"<p class=\"lead\">Un abonnement à un constructeur de pages et un site construit sur mesure peuvent sembler similaires le jour du lancement. La différence apparaît dix-huit mois plus tard, quand vous avez besoin de quelque chose que la plateforme n'a jamais été conçue pour faire.</p><h2>Ce que vous choisissez vraiment</h2><p>Un constructeur SaaS vous loue une plateforme : rapide à démarrer, coût mensuel prévisible, mais votre site vit dans le système de quelqu'un d'autre, avec de réelles limites sur la structure, les intégrations et l'export de données.</p><p>Un build sur mesure coûte plus cher au départ et vous donne un produit fonctionnel que vous possédez entièrement : votre code, vos données, votre choix d'hébergement, et aucune migration forcée plus tard.</p><div class=\"fact-grid\"><p><strong>Les constructeurs conviennent à</strong><br>Des sites simples, à faible risque, avec des besoins standards</p><p><strong>Le sur mesure convient à</strong><br>Des sites étroitement liés à la façon dont l'entreprise fonctionne réellement</p></div><h2>Questions qui révèlent la bonne réponse</h2><ul><li>L'entreprise dépend-elle d'une logique spécifique de réservation, catalogue ou flux de travail ?</li><li>Aurez-vous besoin d'intégrations que l'app store du constructeur n'offre pas ?</li><li>Changer de plateforme plus tard est-il un coût acceptable, ou un risque réel ?</li><li>La vitesse de page et la visibilité dans les recherches affectent-elles matériellement le revenu ?</li><li>Qui doit modifier le contenu au quotidien, et quel est son niveau technique ?</li></ul><h2>Un juste milieu raisonnable</h2><p>Certaines entreprises lancent léger sur un constructeur, prouvent la demande, puis commandent un build sur mesure une fois que les exigences sont réelles plutôt qu'hypothétiques. Cet ordre est souvent plus intelligent que de deviner à l'avance.</p><h3>Nous sommes honnêtes sur le compromis</h3><p>Nous construisons des produits sur mesure parce que c'est là que nous ajoutons le plus de valeur — pas parce qu'un constructeur est toujours le mauvais choix pour un site très simple.</p>",seo_title:"Louer ou posséder votre site web : constructeurs de plateforme comparés à un build sur mesure | Italy Developers",seo_description:"Une comparaison lucide entre les constructeurs de sites SaaS et un build sur mesure, basée sur ce que vous contrôlez réellement.",cta:"Demandez une proposition concrète"},
        Translated{slug:"noleggiare-o-possedere-il-sito-web",lang:"pt",title:"Alugar ou possuir seu site: construtores de plataforma comparados a uma build sob medida",eyebrow:"Framework de decisão",summary:"Uma comparação lúcida entre construtores de sites SaaS e uma build sob medida, baseada no que você realmente controla.",glance:"As perguntas exatas que separam uma empresa que deveria alugar um construtor de outra que precisa de uma build sob medida.",body:"<p class=\"lead\">Uma assinatura de construtor de páginas e um site construído sob medida podem parecer semelhantes no dia do lançamento. A diferença aparece dezoito meses depois, quando você precisa de algo que a plataforma nunca foi projetada para fazer.</p><h2>O que você está realmente escolhendo</h2><p>Um construtor SaaS aluga uma plataforma para você: rápido de iniciar, custo mensal previsível, mas seu site vive dentro do sistema de outra pessoa, com limites reais de estrutura, integrações e exportação de dados.</p><p>Uma build sob medida custa mais no início e oferece um produto funcional que você possui totalmente: seu código, seus dados, sua escolha de hospedagem, e nenhuma migração forçada no futuro.</p><div class=\"fact-grid\"><p><strong>Construtores servem</strong><br>Sites simples e de baixo risco com necessidades padrão</p><p><strong>Sob medida serve</strong><br>Sites intimamente ligados a como a empresa realmente opera</p></div><h2>Perguntas que revelam a resposta certa</h2><ul><li>A empresa depende de uma lógica específica de reserva, catálogo ou fluxo de trabalho?</li><li>Você precisará de integrações que a app store do construtor não oferece?</li><li>Trocar de plataforma depois é um custo aceitável, ou um risco real?</li><li>A velocidade da página e a visibilidade em buscas afetam materialmente a receita?</li><li>Quem precisa editar o conteúdo diariamente, e quão técnico é essa pessoa?</li></ul><h2>Um meio-termo razoável</h2><p>Algumas empresas lançam de forma enxuta em um construtor, comprovam a demanda e depois encomendam uma build sob medida quando os requisitos são reais em vez de hipotéticos. Essa sequência costuma ser mais inteligente do que adivinhar de antemão.</p><h3>Somos honestos sobre o trade-off</h3><p>Construímos produtos sob medida porque é onde agregamos mais valor — não porque um construtor seja sempre a escolha errada para um site muito simples.</p>",seo_title:"Alugar ou possuir seu site: construtores de plataforma comparados a uma build sob medida | Italy Developers",seo_description:"Uma comparação lúcida entre construtores de sites SaaS e uma build sob medida, baseada no que você realmente controla.",cta:"Solicite uma proposta concreta"},
    ];
    apply_translations(db, "insight", &rows).await
}

async fn apply_translations_about_v1(db: &Database) -> Result<(), AppError> {
    let rows: Vec<Translated> = vec![
        Translated{slug:"our-approach",lang:"it",title:"Una community globale di sviluppatori per l'Italia",eyebrow:"La nostra missione",summary:"Italy Developers riunisce sviluppatori da tutto il mondo per una missione mirata: aiutare le imprese locali e gli individui italiani a usare bene la tecnologia.",glance:"",body:"<p class=\"lead\">Italy Developers è una community globale di sviluppatori con una missione di servizio esclusivamente italiana. I contributori possono unirsi da qualsiasi paese, ma il lavoro commerciale della community è dedicato esclusivamente a persone e imprese in Italia.</p><h2>Perché esiste questa community</h2><p>Negozi locali, professionisti, associazioni, creator e piccole aziende spesso hanno bisogno di tecnologia pratica senza la complessità enterprise. Colleghiamo sviluppatori capaci intorno a questo bisogno e costruiamo siti web mirati, applicazioni, API, dashboard e strumenti AI responsabili.</p><div class=\"fact-grid\"><p><strong>Community</strong><br>Aperta a sviluppatori di tutto il mondo</p><p><strong>Missione cliente</strong><br>Esclusivamente per l'Italia</p></div><h2>Chi può partecipare</h2><p>Sviluppatori, designer, tester, technical writer, professionisti DevOps e specialisti di AI responsabile da qualsiasi parte del mondo possono contribuire. Ciò che conta è competenza utile, comunicazione onesta e rispetto per la missione della community focalizzata sull'Italia.</p><h2>Per chi costruiamo</h2><ul><li>Imprese locali e familiari italiane</li><li>Professionisti indipendenti e creator in Italia</li><li>Organizzazioni comunitarie italiane e iniziative locali pratiche</li><li>Individui in Italia che hanno bisogno di un prodotto digitale utile</li></ul><p>Non accettiamo lavoro commerciale per imprese o individui fuori dall'Italia. La partecipazione globale rafforza il team; l'Italia resta l'unico mercato beneficiario.</p><h2>Come lavoriamo</h2><p>I progetti usano ambito chiaro, milestone visibili, interfacce accessibili, dati controllati dal proprietario e tecnologia che il cliente può realisticamente mantenere. Non inventiamo mai risultati di portfolio né promettiamo capacità che il team non può consegnare.</p>",seo_title:"Una community globale di sviluppatori per l'Italia | Italy Developers",seo_description:"Italy Developers riunisce sviluppatori da tutto il mondo per una missione mirata: aiutare le imprese locali e gli individui italiani a usare bene la tecnologia.",cta:"Richiedi una proposta concreta"},
        Translated{slug:"our-approach",lang:"de",title:"Eine globale Entwickler-Community für Italien",eyebrow:"Unsere Mission",summary:"Italy Developers bringt Entwickler aus aller Welt für eine fokussierte Mission zusammen: italienischen lokalen Unternehmen und Einzelpersonen zu helfen, Technologie gut zu nutzen.",glance:"",body:"<p class=\"lead\">Italy Developers ist eine weltweite Entwickler-Community mit einer ausschließlich auf Italien ausgerichteten Servicemission. Mitwirkende können aus jedem Land beitreten, aber die kommerzielle Arbeit der Community ist ausschließlich Menschen und Unternehmen in Italien gewidmet.</p><h2>Warum diese Community existiert</h2><p>Lokale Geschäfte, Fachkräfte, Vereine, Creator und kleine Unternehmen brauchen oft praktische Technologie ohne Enterprise-Komplexität. Wir verbinden fähige Entwickler rund um diesen Bedarf und bauen fokussierte Websites, Anwendungen, APIs, Dashboards und verantwortungsvolle KI-Tools.</p><div class=\"fact-grid\"><p><strong>Community</strong><br>Offen für Entwickler weltweit</p><p><strong>Kundenmission</strong><br>Ausschließlich für Italien</p></div><h2>Wer beitreten kann</h2><p>Entwickler, Designer, Tester, technische Autoren, DevOps-Praktiker und Spezialisten für verantwortungsvolle KI von überall auf der Welt können beitragen. Was zählt, sind nützliche Fähigkeiten, ehrliche Kommunikation und Respekt vor der Italien-fokussierten Mission der Community.</p><h2>Für wen wir bauen</h2><ul><li>Italienische lokale und Familienunternehmen</li><li>Unabhängige Fachkräfte und Creator in Italien</li><li>Italienische Gemeinschaftsorganisationen und praktische lokale Initiativen</li><li>Einzelpersonen in Italien, die ein nützliches digitales Produkt brauchen</li></ul><p>Wir übernehmen keine kommerzielle Arbeit für Unternehmen oder Einzelpersonen außerhalb Italiens. Weltweite Teilnahme stärkt das Team; Italien bleibt der einzige Nutznießer-Markt.</p><h2>Wie wir arbeiten</h2><p>Projekte nutzen klaren Umfang, sichtbare Meilensteine, barrierefreie Oberflächen, inhabergesteuerte Daten und Technologie, die der Kunde realistisch pflegen kann. Wir erfinden niemals Portfolio-Ergebnisse oder versprechen Fähigkeiten, die das Team nicht liefern kann.</p>",seo_title:"Eine globale Entwickler-Community für Italien | Italy Developers",seo_description:"Italy Developers bringt Entwickler aus aller Welt für eine fokussierte Mission zusammen: italienischen lokalen Unternehmen und Einzelpersonen zu helfen, Technologie gut zu nutzen.",cta:"Fordern Sie einen konkreten Vorschlag an"},
        Translated{slug:"our-approach",lang:"fr",title:"Une communauté mondiale de développeurs pour l'Italie",eyebrow:"Notre mission",summary:"Italy Developers réunit des développeurs du monde entier pour une mission ciblée : aider les entreprises locales et les particuliers italiens à bien utiliser la technologie.",glance:"",body:"<p class=\"lead\">Italy Developers est une communauté mondiale de développeurs avec une mission de service exclusivement italienne. Les contributeurs peuvent rejoindre depuis n'importe quel pays, mais le travail commercial de la communauté est dédié exclusivement aux personnes et entreprises en Italie.</p><h2>Pourquoi cette communauté existe</h2><p>Les commerces locaux, professionnels, associations, créateurs et petites entreprises ont souvent besoin de technologie pratique sans la complexité de l'entreprise. Nous connectons des développeurs compétents autour de ce besoin et construisons des sites web ciblés, applications, API, tableaux de bord et outils d'IA responsables.</p><div class=\"fact-grid\"><p><strong>Communauté</strong><br>Ouverte aux développeurs du monde entier</p><p><strong>Mission client</strong><br>Exclusivement pour l'Italie</p></div><h2>Qui peut rejoindre</h2><p>Développeurs, designers, testeurs, rédacteurs techniques, praticiens DevOps et spécialistes de l'IA responsable de partout dans le monde peuvent contribuer. Ce qui compte, c'est une compétence utile, une communication honnête et le respect de la mission de la communauté centrée sur l'Italie.</p><h2>Pour qui nous construisons</h2><ul><li>Entreprises locales et familiales italiennes</li><li>Professionnels indépendants et créateurs en Italie</li><li>Organisations communautaires italiennes et initiatives locales pratiques</li><li>Particuliers en Italie ayant besoin d'un produit numérique utile</li></ul><p>Nous n'acceptons pas de travail commercial pour des entreprises ou particuliers hors d'Italie. La participation mondiale renforce l'équipe ; l'Italie reste le seul marché bénéficiaire.</p><h2>Comment nous travaillons</h2><p>Les projets utilisent un périmètre clair, des jalons visibles, des interfaces accessibles, des données contrôlées par le propriétaire et une technologie que le client peut réalistement maintenir. Nous n'inventons jamais de résultats de portfolio ni ne promettons de capacités que l'équipe ne peut pas livrer.</p>",seo_title:"Une communauté mondiale de développeurs pour l'Italie | Italy Developers",seo_description:"Italy Developers réunit des développeurs du monde entier pour une mission ciblée : aider les entreprises locales et les particuliers italiens à bien utiliser la technologie.",cta:"Demandez une proposition concrète"},
        Translated{slug:"our-approach",lang:"pt",title:"Uma comunidade global de desenvolvedores para a Itália",eyebrow:"Nossa missão",summary:"A Italy Developers reúne desenvolvedores de todo o mundo para uma missão focada: ajudar empresas locais e indivíduos italianos a usar bem a tecnologia.",glance:"",body:"<p class=\"lead\">Italy Developers é uma comunidade mundial de desenvolvedores com uma missão de serviço exclusivamente italiana. Colaboradores podem se juntar de qualquer país, mas o trabalho comercial da comunidade é dedicado exclusivamente a pessoas e empresas na Itália.</p><h2>Por que esta comunidade existe</h2><p>Lojas locais, profissionais, associações, criadores e pequenas empresas frequentemente precisam de tecnologia prática sem a complexidade corporativa. Conectamos desenvolvedores capazes em torno dessa necessidade e construímos sites, aplicações, APIs, painéis e ferramentas de IA responsáveis focados.</p><div class=\"fact-grid\"><p><strong>Comunidade</strong><br>Aberta a desenvolvedores do mundo todo</p><p><strong>Missão do cliente</strong><br>Exclusivamente para a Itália</p></div><h2>Quem pode participar</h2><p>Desenvolvedores, designers, testadores, redatores técnicos, profissionais de DevOps e especialistas em IA responsável de qualquer lugar do mundo podem contribuir. O que importa é habilidade útil, comunicação honesta e respeito pela missão da comunidade focada na Itália.</p><h2>Para quem construímos</h2><ul><li>Empresas locais e familiares italianas</li><li>Profissionais independentes e criadores na Itália</li><li>Organizações comunitárias italianas e iniciativas locais práticas</li><li>Indivíduos na Itália que precisam de um produto digital útil</li></ul><p>Não aceitamos trabalho comercial para empresas ou indivíduos fora da Itália. A participação mundial fortalece a equipe; a Itália permanece o único mercado beneficiário.</p><h2>Como trabalhamos</h2><p>Os projetos usam escopo claro, marcos visíveis, interfaces acessíveis, dados controlados pelo proprietário e tecnologia que o cliente pode manter de forma realista. Nunca inventamos resultados de portfólio nem prometemos capacidades que a equipe não pode entregar.</p>",seo_title:"Uma comunidade global de desenvolvedores para a Itália | Italy Developers",seo_description:"A Italy Developers reúne desenvolvedores de todo o mundo para uma missão focada: ajudar empresas locais e indivíduos italianos a usar bem a tecnologia.",cta:"Solicite uma proposta concreta"},

        Translated{slug:"join-the-community",lang:"it",title:"Unisciti a Italy Developers",eyebrow:"Membership globale",summary:"Sviluppatori in ogni parte del mondo possono contribuire con le proprie competenze a una tecnologia che serve le imprese locali e gli individui italiani.",glance:"",body:"<p class=\"lead\">Non devi vivere in Italia per unirti a Italy Developers. Devi però sostenere la missione: tecnologia pratica e responsabile per persone e piccole organizzazioni in Italia.</p><h2>Modi per contribuire</h2><ul><li>Ingegneria Rust, Python, Django e API</li><li>Frontend accessibile e lavoro di interfaccia responsive</li><li>Test, revisione della sicurezza e deployment</li><li>Contenuti, documentazione e localizzazione italiana</li><li>Valutazione AI responsabile e salvaguardie di prodotto</li></ul><h2>Cosa possono aspettarsi i membri</h2><p>Problemi reali di portfolio, lavoro revisionabile, proprietà chiara e opportunità di apprendere tra tecnologie diverse. I contributi dovrebbero essere documentati e rispettosi della privacy dei clienti.</p><h2>Inizia una conversazione</h2><p>Usa la pagina contatti e menziona le tue competenze, il fuso orario, le tecnologie preferite e il tipo di progetto focalizzato sull'Italia che vuoi sostenere.</p>",seo_title:"Unisciti a Italy Developers | Italy Developers",seo_description:"Sviluppatori in ogni parte del mondo possono contribuire con le proprie competenze a una tecnologia che serve le imprese locali e gli individui italiani.",cta:"Richiedi una proposta concreta"},
        Translated{slug:"join-the-community",lang:"de",title:"Treten Sie Italy Developers bei",eyebrow:"Weltweite Mitgliedschaft",summary:"Entwickler überall auf der Welt können ihre Fähigkeiten zu Technologie beitragen, die italienischen lokalen Unternehmen und Einzelpersonen dient.",glance:"",body:"<p class=\"lead\">Sie müssen nicht in Italien leben, um Italy Developers beizutreten. Sie müssen jedoch die Mission unterstützen: praktische, verantwortungsvolle Technologie für Menschen und kleine Organisationen in Italien.</p><h2>Wege, beizutragen</h2><ul><li>Rust-, Python-, Django- und API-Engineering</li><li>Barrierefreie Frontend- und responsive Interface-Arbeit</li><li>Tests, Sicherheitsprüfung und Deployment</li><li>Inhalte, Dokumentation und italienische Lokalisierung</li><li>Verantwortungsvolle KI-Bewertung und Produktschutzmaßnahmen</li></ul><h2>Was Mitglieder erwarten können</h2><p>Echte Portfolio-Probleme, überprüfbare Arbeit, klares Eigentum und Möglichkeiten, technologieübergreifend zu lernen. Beiträge sollten dokumentiert und respektvoll gegenüber der Privatsphäre der Kunden sein.</p><h2>Ein Gespräch beginnen</h2><p>Nutzen Sie die Kontaktseite und erwähnen Sie Ihre Fähigkeiten, Zeitzone, bevorzugten Technologien und die Art des Italien-fokussierten Projekts, das Sie unterstützen möchten.</p>",seo_title:"Treten Sie Italy Developers bei | Italy Developers",seo_description:"Entwickler überall auf der Welt können ihre Fähigkeiten zu Technologie beitragen, die italienischen lokalen Unternehmen und Einzelpersonen dient.",cta:"Fordern Sie einen konkreten Vorschlag an"},
        Translated{slug:"join-the-community",lang:"fr",title:"Rejoignez Italy Developers",eyebrow:"Adhésion mondiale",summary:"Des développeurs partout dans le monde peuvent contribuer leurs compétences à une technologie qui sert les entreprises locales et les particuliers italiens.",glance:"",body:"<p class=\"lead\">Vous n'avez pas besoin de vivre en Italie pour rejoindre Italy Developers. Vous devez cependant soutenir la mission : une technologie pratique et responsable pour les personnes et petites organisations en Italie.</p><h2>Façons de contribuer</h2><ul><li>Ingénierie Rust, Python, Django et API</li><li>Frontend accessible et travail d'interface responsive</li><li>Tests, revue de sécurité et déploiement</li><li>Contenu, documentation et localisation italienne</li><li>Évaluation IA responsable et garanties produit</li></ul><h2>Ce que les membres peuvent attendre</h2><p>De vrais problèmes de portfolio, un travail vérifiable, une propriété claire et des opportunités d'apprendre à travers les technologies. Les contributions doivent être documentées et respectueuses de la confidentialité des clients.</p><h2>Démarrer une conversation</h2><p>Utilisez la page de contact et mentionnez vos compétences, votre fuseau horaire, vos technologies préférées et le type de projet centré sur l'Italie que vous souhaitez soutenir.</p>",seo_title:"Rejoignez Italy Developers | Italy Developers",seo_description:"Des développeurs partout dans le monde peuvent contribuer leurs compétences à une technologie qui sert les entreprises locales et les particuliers italiens.",cta:"Demandez une proposition concrète"},
        Translated{slug:"join-the-community",lang:"pt",title:"Junte-se à Italy Developers",eyebrow:"Associação mundial",summary:"Desenvolvedores em qualquer lugar do mundo podem contribuir com suas habilidades para uma tecnologia que serve empresas locais e indivíduos italianos.",glance:"",body:"<p class=\"lead\">Você não precisa morar na Itália para se juntar à Italy Developers. Você precisa, sim, apoiar a missão: tecnologia prática e responsável para pessoas e pequenas organizações na Itália.</p><h2>Formas de contribuir</h2><ul><li>Engenharia Rust, Python, Django e API</li><li>Frontend acessível e trabalho de interface responsiva</li><li>Testes, revisão de segurança e implantação</li><li>Conteúdo, documentação e localização em italiano</li><li>Avaliação de IA responsável e salvaguardas de produto</li></ul><h2>O que os membros podem esperar</h2><p>Problemas reais de portfólio, trabalho revisável, propriedade clara e oportunidades de aprender entre tecnologias. As contribuições devem ser documentadas e respeitosas com a privacidade dos clientes.</p><h2>Inicie uma conversa</h2><p>Use a página de contato e mencione suas habilidades, fuso horário, tecnologias preferidas e o tipo de projeto focado na Itália que você quer apoiar.</p>",seo_title:"Junte-se à Italy Developers | Italy Developers",seo_description:"Desenvolvedores em qualquer lugar do mundo podem contribuir com suas habilidades para uma tecnologia que serve empresas locais e indivíduos italianos.",cta:"Solicite uma proposta concreta"},
    ];
    apply_translations(db, "about", &rows).await
}

async fn apply_translations_testimonial_v1(db: &Database) -> Result<(), AppError> {
    let body_it = "Prova di portfolio verificata. Non è implicita alcuna citazione del cliente o dichiarazione di performance.";
    let body_de = "Verifizierter Portfolio-Beleg. Kein Kundenzitat oder Leistungsanspruch wird impliziert.";
    let body_fr = "Preuve de portfolio vérifiée. Aucune citation client ou allégation de performance n'est impliquée.";
    let body_pt = "Evidência de portfólio verificada. Nenhuma citação de cliente ou alegação de desempenho está implícita.";
    let rows: Vec<Translated> = vec![
        Translated{slug:"italy-developers-proof",lang:"it",title:"Italy Developers CMS",eyebrow:"Rust · Actix · MongoDB",summary:"CMS pronto per la produzione con editing basato sui ruoli, upload, SEO, contatti, commenti annidati, like e deployment Docker.",glance:"",body:body_it,seo_title:"",seo_description:"",cta:"Guarda il lavoro"},
        Translated{slug:"italy-developers-proof",lang:"de",title:"Italy Developers CMS",eyebrow:"Rust · Actix · MongoDB",summary:"Produktionsreifes CMS mit rollenbasierter Bearbeitung, Uploads, SEO, Leads, verschachtelten Kommentaren, Likes und Docker-Deployment.",glance:"",body:body_de,seo_title:"",seo_description:"",cta:"Arbeit ansehen"},
        Translated{slug:"italy-developers-proof",lang:"fr",title:"Italy Developers CMS",eyebrow:"Rust · Actix · MongoDB",summary:"CMS prêt pour la production avec édition basée sur les rôles, téléversements, SEO, prospects, commentaires imbriqués, likes et déploiement Docker.",glance:"",body:body_fr,seo_title:"",seo_description:"",cta:"Voir le travail"},
        Translated{slug:"italy-developers-proof",lang:"pt",title:"Italy Developers CMS",eyebrow:"Rust · Actix · MongoDB",summary:"CMS pronto para produção com edição baseada em funções, uploads, SEO, leads, comentários aninhados, curtidas e implantação Docker.",glance:"",body:body_pt,seo_title:"",seo_description:"",cta:"Ver o trabalho"},

        Translated{slug:"doappointment-proof",lang:"it",title:"DoAppointment",eyebrow:"Scheduling · Profili · Disponibilità",summary:"Capacità di piattaforma appuntamenti che copre profili professionali, orari di lavoro, account cliente e flussi di prenotazione.",glance:"",body:body_it,seo_title:"",seo_description:"",cta:"Guarda il lavoro"},
        Translated{slug:"doappointment-proof",lang:"de",title:"DoAppointment",eyebrow:"Terminplanung · Profile · Verfügbarkeit",summary:"Terminplattform-Fähigkeit mit Fachkräfteprofilen, Arbeitszeiten, Kundenkonten und Buchungsabläufen.",glance:"",body:body_de,seo_title:"",seo_description:"",cta:"Arbeit ansehen"},
        Translated{slug:"doappointment-proof",lang:"fr",title:"DoAppointment",eyebrow:"Planification · Profils · Disponibilité",summary:"Capacité de plateforme de rendez-vous couvrant profils professionnels, horaires de travail, comptes clients et flux de réservation.",glance:"",body:body_fr,seo_title:"",seo_description:"",cta:"Voir le travail"},
        Translated{slug:"doappointment-proof",lang:"pt",title:"DoAppointment",eyebrow:"Agendamento · Perfis · Disponibilidade",summary:"Capacidade de plataforma de agendamento cobrindo perfis profissionais, horários de trabalho, contas de clientes e fluxos de reserva.",glance:"",body:body_pt,seo_title:"",seo_description:"",cta:"Ver o trabalho"},

        Translated{slug:"storemate-proof",lang:"it",title:"StoreMate",eyebrow:"CRM · Inventario · API",summary:"Backend operativo con autenticazione, OTP, prodotti, magazzino, fornitori, avvisi, job in background e API documentate.",glance:"",body:body_it,seo_title:"",seo_description:"",cta:"Guarda il lavoro"},
        Translated{slug:"storemate-proof",lang:"de",title:"StoreMate",eyebrow:"CRM · Inventar · APIs",summary:"Operatives Backend mit Authentifizierung, OTP, Produkten, Lager, Lieferanten, Warnungen, Hintergrundjobs und dokumentierten APIs.",glance:"",body:body_de,seo_title:"",seo_description:"",cta:"Arbeit ansehen"},
        Translated{slug:"storemate-proof",lang:"fr",title:"StoreMate",eyebrow:"CRM · Inventaire · API",summary:"Backend opérationnel avec authentification, OTP, produits, stock, fournisseurs, alertes, tâches en arrière-plan et API documentées.",glance:"",body:body_fr,seo_title:"",seo_description:"",cta:"Voir le travail"},
        Translated{slug:"storemate-proof",lang:"pt",title:"StoreMate",eyebrow:"CRM · Estoque · APIs",summary:"Backend operacional com autenticação, OTP, produtos, estoque, fornecedores, alertas, tarefas em segundo plano e APIs documentadas.",glance:"",body:body_pt,seo_title:"",seo_description:"",cta:"Ver o trabalho"},

        Translated{slug:"drf-shapeless-proof",lang:"it",title:"DRF Shapeless Serializers",eyebrow:"Open source · Python · Django REST",summary:"Pacchetto pubblicato per campi a runtime, rinomina, dati condizionali e configurazione di serializer profondamente annidati.",glance:"",body:body_it,seo_title:"",seo_description:"",cta:"Guarda il lavoro"},
        Translated{slug:"drf-shapeless-proof",lang:"de",title:"DRF Shapeless Serializers",eyebrow:"Open Source · Python · Django REST",summary:"Veröffentlichtes Paket für Laufzeitfelder, Umbenennung, bedingte Daten und tief verschachtelte Serializer-Konfiguration.",glance:"",body:body_de,seo_title:"",seo_description:"",cta:"Arbeit ansehen"},
        Translated{slug:"drf-shapeless-proof",lang:"fr",title:"DRF Shapeless Serializers",eyebrow:"Open source · Python · Django REST",summary:"Paquet publié pour champs à l'exécution, renommage, données conditionnelles et configuration de sérialiseurs profondément imbriqués.",glance:"",body:body_fr,seo_title:"",seo_description:"",cta:"Voir le travail"},
        Translated{slug:"drf-shapeless-proof",lang:"pt",title:"DRF Shapeless Serializers",eyebrow:"Open source · Python · Django REST",summary:"Pacote publicado para campos em tempo de execução, renomeação, dados condicionais e configuração de serializers profundamente aninhados.",glance:"",body:body_pt,seo_title:"",seo_description:"",cta:"Ver o trabalho"},

        Translated{slug:"jgob-proof",lang:"it",title:"Piattaforma JGOB",eyebrow:"Community · Commercio · Pagamenti",summary:"Contenuti, cause, volontari, catalogo prodotti, carrello, checkout e integrazione pagamenti in un'unica piattaforma Django.",glance:"",body:body_it,seo_title:"",seo_description:"",cta:"Guarda il lavoro"},
        Translated{slug:"jgob-proof",lang:"de",title:"JGOB-Plattform",eyebrow:"Community · Commerce · Zahlungen",summary:"Inhalte, Anliegen, Freiwillige, Produktkatalog, Warenkorb, Checkout und Zahlungsintegration in einer Django-Plattform.",glance:"",body:body_de,seo_title:"",seo_description:"",cta:"Arbeit ansehen"},
        Translated{slug:"jgob-proof",lang:"fr",title:"Plateforme JGOB",eyebrow:"Communauté · Commerce · Paiements",summary:"Contenu, causes, bénévoles, catalogue de produits, panier, paiement et intégration de paiement dans une seule plateforme Django.",glance:"",body:body_fr,seo_title:"",seo_description:"",cta:"Voir le travail"},
        Translated{slug:"jgob-proof",lang:"pt",title:"Plataforma JGOB",eyebrow:"Comunidade · Comércio · Pagamentos",summary:"Conteúdo, causas, voluntários, catálogo de produtos, carrinho, checkout e integração de pagamento em uma única plataforma Django.",glance:"",body:body_pt,seo_title:"",seo_description:"",cta:"Ver o trabalho"},

        Translated{slug:"pet-care-proof",lang:"it",title:"Pet Care AI",eyebrow:"In arrivo · AI responsabile",summary:"Profili animali per proprietario e analisi audio probabilistica del cane, progettati con incertezza visibile e confini di sicurezza chiari.",glance:"",body:body_it,seo_title:"",seo_description:"",cta:"Guarda il lavoro"},
        Translated{slug:"pet-care-proof",lang:"de",title:"Pet Care AI",eyebrow:"Demnächst · Verantwortungsvolle KI",summary:"Besitzergebundene Tierprofile und probabilistische Hunde-Audioanalyse, entworfen mit sichtbarer Unsicherheit und klaren Sicherheitsgrenzen.",glance:"",body:body_de,seo_title:"",seo_description:"",cta:"Arbeit ansehen"},
        Translated{slug:"pet-care-proof",lang:"fr",title:"Pet Care AI",eyebrow:"À venir · IA responsable",summary:"Profils d'animaux liés au propriétaire et analyse audio probabiliste du chien, conçus avec incertitude visible et limites de sécurité claires.",glance:"",body:body_fr,seo_title:"",seo_description:"",cta:"Voir le travail"},
        Translated{slug:"pet-care-proof",lang:"pt",title:"Pet Care AI",eyebrow:"Em breve · IA responsável",summary:"Perfis de animais vinculados ao proprietário e análise de áudio probabilística do cão, projetados com incerteza visível e limites de segurança claros.",glance:"",body:body_pt,seo_title:"",seo_description:"",cta:"Ver o trabalho"},
    ];
    apply_translations(db, "testimonial", &rows).await
}
