...
#[derive(Debug,Error)] pub enum AppError { #[error("not found")] NotFound, #[error("invalid request")] BadRequest, #[error("forbidden")] Forbidden, #[error("service unavailable")] Database(#[from] mongodb::error::Error), #[error("template error")] Template(#[from] askama::Error) }
